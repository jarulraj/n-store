...
void* p_tree_search(PTree *tree, const void* user_data);
void* p_tree_search_related(PTree *tree, const void* user_data,
                            PTreeSearchType search_type);
void* p_tree_search_v(PTree *tree, unsigned int version, const void* user_data);
